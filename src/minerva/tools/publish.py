"""Convert summaries to audio and optionally post them to Telegram."""
...
from ..pipeline import post_summary_to_telegram, synthesise_speech
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Convert a summary to speech and optionally send it to Telegram.",
    )
    parser.add_argument(
        "--summary",
